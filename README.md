This is a "Vulnerable" Web Application developed by Cyber Security and Privacy Foundation(www.cysecurity.org). This app is intended for the Java Programmers and other people who wish to learn about Web application vulnerabilities and write secure code. Test Abhishek Webhook ewerw
...
**The full course on Hacking and Securing Web Java Programs is available in** reter (Replicating a code change in FeatureBranch)
...
Get the VulnerableSpring Project from here: migration exercise
